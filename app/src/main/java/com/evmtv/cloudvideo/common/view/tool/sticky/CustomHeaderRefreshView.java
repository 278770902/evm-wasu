package com.evmtv.cloudvideo.common.view.tool.sticky;
...
public class CustomHeaderRefreshView extends LinearLayout implements IHeaderCallBack {
    ...
    public CustomHeaderRefreshView(Context context) {
        super(context);
        initView(context);
    }
     ...
     * @param attrs
     */
    public CustomHeaderRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        mContent = (ViewGroup) LayoutInflater.from(context).inflate(
                R.layout.adapter_xrefreshview_header_layout, this);
