...
public class CornersTransformPhoto  extends BitmapTransformation {
    private float radius;

    public CornersTransformPhoto(Context context) {
        super(context);
    }

    public CornersTransformPhoto(Context context, float radius) {
        super(context);
